...
var browsers = [
   ...
   { browserName: 'chrome', os_api_name: 'Mac10.9', browser_api_name: 'Chrome-latest', screen_resolution: '1024x768' },
   { browserName: 'chrome', os_api_name: 'Mac10.9', browser_api_name: 'Chrome-latest', screen_resolution: '1366x768' },
   { browserName: 'chrome', os_api_name: 'Mac10.9', browser_api_name: 'Chrome-latest', screen_resolution: '1600x1200' },
   { browserName: 'chrome', os_api_name: 'Mac10.9', browser_api_name: 'Chrome-latest', screen_resolution: '1280x800' },
   { browserName: 'internet explorer', os_api_name: 'Win8.1', browser_api_name: 'IE11', screen_resolution: '1024x768' },
   { browserName: 'internet explorer', os_api_name: 'Win8.1', browser_api_name: 'IE11', screen_resolution: '1366x768' },
   { browserName: 'internet explorer', os_api_name: 'Win8.1', browser_api_name: 'IE11', screen_resolution: '1600x1200' },
   { browserName: 'internet explorer', os_api_name: 'Win8.1', browser_api_name: 'IE11', screen_resolution: '1280x768' }
